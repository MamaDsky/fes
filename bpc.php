...
<head>
    ...
    <title>Business Plan Competition | Manifest 2026</title>
    ...
    <main>
        ...
        <section class="bpc-hero-multipage relative pt-40 pb-16 px-5 sm:px-8 md:px-12 lg:px-16 overflow-hidden">
            ...
            <div class="relative z-10 max-w-[1220px] mx-auto flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/10 pb-10">
                <div class="text-left max-w-[640px]">
                    <span class="reveal text-[9px] font-heading font-bold uppercase tracking-[0.20em] text-manifest-cream block mb-2">Movement I &bull; Competition Package</span>
                    <h1 class="reveal delay-100 font-heading font-bold text-4xl md:text-5xl lg:text-6xl text-white uppercase tracking-tight leading-[0.95]">
                        Business Plan <br><span class="font-accent italic text-manifest-cream normal-case font-normal font-serif">Competition</span>
                    </h1>
                    <p class="reveal delay-200 mt-4 text-xs md:text-sm leading-relaxed text-white/70 tracking-wide font-light">
                        Ajang inkubasi taktis berskala nasional untuk menguji kreativitas model perencanaan bisnis yang visioner, profitable, serta berdampak luas pada perwujudan ekonomi sirkular ramah lingkungan.
                    </p>
                </div>
        ...
        <section class="py-12 md:py-16 px-4 sm:px-6 md:px-12 relative z-20">
            <div class="max-w-[1220px] mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5">
                    ...
                    <div class="manifest-soft-card rounded-[1.5rem] p-5 md:p-6 md:col-span-2 flex flex-col justify-between transition-all duration-500 hover:scale-[1.01] hover:shadow-xl reveal">
                        <div>
                            ...
                            <h3 class="font-heading text-lg md:text-xl font-bold text-ink mt-2 mb-3">Fostering Tech-Enabled Circular Solutions</h3>
                            <p class="text-xs leading-relaxed text-ink/60">
                                Peserta ditantang menciptakan rencana usaha baru yang mengintegrasikan kecerdasan teknologi guna mempercepat implementasi siklus ekonomi sirkular yang mereduksi limbah dan ramah keberlanjutan lingkungan.
                            </p>
                        </div>
                        <div class="mt-6 pt-4 border-t border-manifest-dark/5 flex gap-6">
                            <div>
                                ...
                                <span class="font-heading text-xs font-bold text-manifest-burgundy">2 Siswa / Boleh Berbeda Sekolah *</span>
                            </div>
                            <div>
                                <span class="text-[9px] uppercase tracking-wider text-ink/40 block">Skala Kompetisi</span>
                                <span class="font-heading text-xs font-bold text-manifest-burgundy">Nasional</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-manifest-burgundy text-white rounded-[1.5rem] p-5 md:p-6 flex flex-col justify-between shadow-md transition-all duration-500 hover:scale-[1.01] hover:shadow-2xl reveal delay-100">
                        <div>
                            ...
                            <h3 class="font-heading text-base md:text-lg font-bold mt-2 opacity-90">BPC Grand Prize Pool</h3>
                        ...
                        <p class="text-[11px] text-white/60 leading-relaxed border-t border-white/10 pt-3">
                            Distribusi: Juara 1 (5 Jt + Free Pass Bebas Tes Masuk Manajemen Bisnis ITS), Juara 2 (3.5 Jt), Juara 3 (2.5 Jt), & Best Speaker (500 Ribu).
                        </p>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
                                <div class="p-3.5 bg-white/50 rounded-xl border border-manifest-dark/5">
                                    <h4 class="font-heading font-bold text-xs text-manifest-burgundy mb-1">Babak Preliminary: BMC</h4>
                                    <p class="text-[11px] text-ink/60 leading-relaxed mb-2">Format 1 halaman A4 landscape PDF. Format nama: BMC_Nama Tim_Nama Ketua Tim.</p>
                                    <a href="https://its.id/StatementofOriginalityBPC" target="_blank" class="text-[10px] text-manifest-rose underline font-bold flex items-center gap-1 transition-all hover:text-manifest-burgundy"><i class="fas fa-link text-[8px]"></i> Unduh Surat Pernyataan Orisinalitas</a>
                                </div>
                                <div class="p-4 bg-white/50 rounded-xl border border-manifest-dark/5">
                                    ...
                                    <p class="text-[11px] text-ink/60 leading-relaxed">Proposal perencanaan bisnis komprehensif maksimal 15 halaman PDF. Format nama: BPC Proposal_Nama Tim_Nama Ketua Tim.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Catatan Tambahan Lintas Sekolah -->
                <p class="text-[10px] text-ink/40 mt-3 pl-2 italic">
                    * Catatan: Anggota kelompok diperbolehkan berasal dari sekolah yang berbeda, namun di dalam formulir pendaftaran cabang lomba wajib mencantumkan/memilih satu nama instansi sekolah yang sama untuk kebutuhan pengelompokan sistem administrasi.
                </p>
            </div>
        </section>
        ...
        <section class="py-20 md:py-24 px-4 sm:px-6 md:px-12 relative z-20 border-t border-manifest-dark/5 bg-gradient-to-b from-white/30 to-transparent">
            <div class="max-w-[1220px] mx-auto">
                <div class="max-w-2xl mb-16 text-left reveal">
                    ...
                    <p class="text-sm md:text-base text-ink/54 max-w-xl leading-relaxed">Transparansi parameter penentuan skor juri. Skema pembobotan dirancang asimetris menyesuaikan tingkat kedalaman esensi riset di setiap babak.</p>
                </div>
                ...
                <div class="space-y-16">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center gap-4 reveal border-b border-manifest-dark/5 pb-3">
                            ...
                            <h3 class="font-heading font-bold text-lg md:text-xl text-ink uppercase tracking-wide">Babak Preliminary <span class="font-body text-xs text-ink/40 lowercase tracking-normal font-normal pl-2">(Bobot Evaluasi BMC)</span></h3>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4">
                            ...
                            <div class="lg:col-span-4 manifest-soft-card rounded-2xl p-6 flex flex-col justify-between transition-all duration-300 hover:scale-[1.02] reveal delay-100">
                                <div class="flex justify-between items-start">
                                    <span class="text-[9px] uppercase tracking-wider text-ink/40 font-heading font-bold">Kriteria Utama</span>
                                    <div class="w-7 h-7 rounded-full bg-manifest-burgundy/5 flex items-center justify-center text-manifest-burgundy"><i class="fas fa-wallet text-xs"></i></div>
                                </div>
                                <div class="mt-8">
                                    <span class="font-accent italic text-5xl md:text-6xl text-manifest-burgundy leading-none block">30%</span>
                                    <h4 class="font-heading font-bold text-sm text-ink mt-3">Analisis Bisnis & Kelayakan</h4>
                                    <p class="text-[11px] text-ink/50 leading-relaxed mt-1.5">Penilaian mendalam pada aspek rasionalitas keuangan riil, struktur model biaya, aliran pendapatan (revenue stream), serta kelayakan eksekusi hulu ke hilir.</p>
                                </div>
                            </div>
                            ...
                            <div class="lg:col-span-4 manifest-soft-card rounded-2xl p-6 flex flex-col justify-between transition-all duration-300 hover:scale-[1.02] reveal delay-200">
                                <div class="flex justify-between items-start">
                                    <span class="text-[9px] uppercase tracking-wider text-ink/40 font-heading font-bold">Aspek Vital</span>
                                    <div class="w-7 h-7 rounded-full bg-manifest-burgundy/5 flex items-center justify-center text-manifest-burgundy"><i class="fas fa-leaf text-xs"></i></div>
                                </div>
                                <div class="mt-8">
                                    <span class="font-accent italic text-5xl md:text-6xl text-manifest-burgundy leading-none block">25%</span>
                                    <h4 class="font-heading font-bold text-sm text-ink mt-3">Nilai Keberlanjutan Bisnis</h4>
                                    <p class="text-[11px] text-ink/50 leading-relaxed mt-1.5">Mengukur seberapa kuat kontribusi ide terhadap ekonomi sirkular, strategi reduksi limbah karbon, serta dampak proteksi lingkungan jangka panjang.</p>
                                </div>
                            </div>
                            ...
                            <div class="lg:col-span-4 manifest-soft-card rounded-2xl p-6 flex flex-col justify-between transition-all duration-300 hover:scale-[1.02] reveal delay-300">
                                <div class="flex justify-between items-start">
                                    <span class="text-[9px] uppercase tracking-wider text-ink/40 font-heading font-bold">Daya Saing</span>
                                ...
                                <div class="mt-8">
                                    ...
                                    <h4 class="font-heading font-bold text-sm text-ink mt-3">Kreativitas & Inovasi Model</h4>
                                    <p class="text-[11px] text-ink/50 leading-relaxed mt-1.5">Keunikan proposisi nilai (unique value proposition) dibanding kompetitor yang ada di pasar serta kebaruan kerangka kerja taktis penyusunan skema.</p>
                                </div>
                            </div>

                            <!-- Row Bawah: 10%, 10%, 5% di-bento-in horisontal -->
                            <div class="sm:col-span-2 lg:col-span-4 bg-white/60 backdrop-blur-md border border-manifest-dark/5 rounded-2xl p-5 flex items-center gap-4 transition-all duration-300 hover:scale-[1.01] reveal">
                                ...
                                <div>
                                    <h4 class="font-heading font-bold text-xs text-ink">Kesesuaian Tema Utama</h4>
                                    <p class="text-[11px] text-ink/50 leading-tight mt-0.5">Keselarasan visi orisinalitas kanvas terhadap koridor ekonomi sirkular modern.</p>
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2 lg:col-span-4 bg-white/60 backdrop-blur-md border border-manifest-dark/5 rounded-2xl p-5 flex items-center gap-4 transition-all duration-300 hover:scale-[1.01] reveal delay-100">
                                <span class="font-accent italic text-4xl text-manifest-rose font-bold shrink-0">10%</span>
                                <div>
                                    <h4 class="font-heading font-bold text-xs text-ink">Struktur Elemen BMC</h4>
                                    <p class="text-[11px] text-ink/50 leading-tight mt-0.5">Ketepatan korelasi logika pengisian antar 9 blok matriks Business Model Canvas.</p>
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2 lg:col-span-4 bg-white/40 backdrop-blur-md border border-manifest-dark/5 border-dashed rounded-2xl p-5 flex items-center gap-4 transition-all duration-300 hover:scale-[1.01] reveal delay-200">
                                ...
                                <div>
                                    <h4 class="font-heading font-bold text-xs text-ink/70">Format Tata Bahasa (PUEBI)</h4>
                                    <p class="text-[11px] text-ink/40 leading-tight mt-0.5">Kerapian ketikan tata letak, diksi akademis formal, kejelasan narasi poin.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6 pt-6">
                        <div class="flex items-center gap-4 reveal border-b border-manifest-dark/5 pb-3">
                            ...
                            <h3 class="font-heading font-bold text-lg md:text-xl text-ink uppercase tracking-wide">Babak Semifinal <span class="font-body text-xs text-ink/40 lowercase tracking-normal font-normal pl-2">(Bobot Evaluasi Proposal Makro)</span></h3>
                        </div>
                        
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                            <!-- Mega Dominant Card: 45% -->
                            <div class="md:col-span-6 lg:col-span-5 bg-manifest-burgundy text-cream rounded-3xl p-6 md:p-8 flex flex-col justify-between shadow-lg transition-all duration-300 hover:scale-[1.01] hover:shadow-2xl reveal">
                                <div>
                                    <div class="flex justify-between items-start border-b border-white/10 pb-4">
                                        <span class="text-[8px] font-heading font-bold uppercase tracking-widest text-manifest-cream/50">Core Pillar Evaluation</span>
                                    ...
                                    <div class="mt-8 md:mt-12">
                                        <span class="font-accent italic text-6xl md:text-7xl lg:text-8xl text-manifest-cream leading-none block">45%</span>
                                        <h4 class="font-heading font-bold text-base text-white mt-4 uppercase tracking-wide">Analisis & Validasi Fungsional</h4>
                                        <p class="text-xs text-manifest-cream/70 leading-relaxed mt-2.5">
                                            Bobot tertinggi mutlak ditekankan pada kedalaman integrasi taktis laporan. Mencakup validitas riset pasar riil, kalkulasi proyeksi arus kas finansial (NPV, IRR, Payback Period), manajemen risiko, dan rencana eksekusi operasional pemasaran digital.
                                        </p>
                                    </div>
                                </div>
                                <div class="mt-8 pt-4 border-t border-white/10 text-[10px] text-manifest-cream/40 font-light uppercase tracking-wider">
                                    Mandatory Passing Grade Pillar
                                </div>
                            </div>

                            <!-- Right Side Dashboard Grid inside Semifinal -->
                            <div class="md:col-span-6 lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div class="manifest-soft-card rounded-2xl p-6 flex flex-col justify-between transition-all duration-300 hover:scale-[1.02] reveal delay-100">
                                    <div>
                                        <div class="w-6 h-6 rounded-full bg-manifest-burgundy/5 flex items-center justify-center text-manifest-burgundy text-[10px]"><i class="fas fa-wand-magic-sparkles"></i></div>
                                        <h4 class="font-heading font-bold text-xs text-ink mt-3">Kreativitas Perencanaan</h4>
                                    </div>
                                    <div class="mt-6">
                                        <span class="font-accent italic text-4xl text-manifest-burgundy block leading-none">13.5%</span>
                                        <p class="text-[11px] text-ink/50 leading-normal mt-1">Kebaruan solusi alternatif atas penyelesaian problem industri riobatik.</p>
                                    </div>
                                </div>
                                ...
                                <div class="manifest-soft-card rounded-2xl p-6 flex flex-col justify-between transition-all duration-300 hover:scale-[1.02] reveal delay-200">
                                    <div>
                                        <div class="w-6 h-6 rounded-full bg-manifest-burgundy/5 flex items-center justify-center text-manifest-burgundy text-[10px]"><i class="fas fa-globe-americas"></i></div>
                                        <h4 class="font-heading font-bold text-xs text-ink mt-3">Dampak Bisnis (3P Matrix)</h4>
                                    </div>
                                    <div class="mt-6">
                                        <span class="font-accent italic text-4xl text-manifest-burgundy block leading-none">11.5%</span>
                                        <p class="text-[11px] text-ink/50 leading-normal mt-1">Efektivitas keberimbangan kontribusi ekonomi pada People, Planet, Profit.</p>
                                    </div>
                                </div>

                                <div class="bg-white/70 border border-manifest-dark/5 rounded-2xl p-5 flex flex-col justify-between transition-all duration-300 hover:scale-[1.02] reveal delay-100">
                                    <div class="flex justify-between items-center">
                                        <h4 class="font-heading font-bold text-xs text-ink">Rasionalitas Eksekusi (Feasible)</h4>
                                        <span class="font-accent italic text-2xl text-manifest-rose font-bold">10%</span>
                                    </div>
                                    <p class="text-[11px] text-ink/50 leading-normal mt-2">Tingkat kemungkinan implementasi nyata gagasan di pasar komersial saat ini.</p>
                                </div>
                                ...
                                <div class="bg-white/70 border border-manifest-dark/5 rounded-2xl p-5 flex flex-col justify-between transition-all duration-300 hover:scale-[1.02] reveal delay-200">
                                    <div class="flex justify-between items-center">
                                        <h4 class="font-heading font-bold text-xs text-ink">Sistematika & Penulisan</h4>
                                        <span class="font-accent italic text-2xl text-manifest-rose font-bold">10%</span>
                                    </div>
                                    <p class="text-[11px] text-ink/50 leading-normal mt-2">Kepatuhan total terhadap regulasi batas margin halaman, jumlah lembar, dan PUEBI.</p>
                                </div>

                                <div class="sm:col-span-2 bg-white/45 border border-manifest-dark/5 border-dashed rounded-2xl p-4 flex items-center justify-between transition-all duration-300 hover:scale-[1.01] reveal delay-300">
                                    <div class="flex items-center gap-3">
                                        <span class="font-accent italic text-3xl text-ink/40 font-bold">10%</span>
                                        <div class="w-px h-6 bg-manifest-dark/10"></div>
                                        <div>
                                            <h4 class="font-heading font-bold text-xs text-ink/80">Kualitas Referensi & Framework</h4>
                                            <p class="text-[10px] text-ink/40">Validitas sitasi jurnal pendukung ilmiah, penggunaan pisau analisis swot/pestel baku.</p>
                                        </div>
                                    </div>
                                    <div class="text-manifest-rose text-xs hidden sm:block"><i class="fas fa-bookmark"></i></div>
                                </div>
            ...
            <div class="max-w-[1220px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                <div class="lg:col-span-7 max-w-xl text-left reveal">
                    ...
                    <p class="text-xs leading-relaxed text-ink/60 mt-3">
                        Sebagai bagian dari agenda eksklusif <b>3-Day Business Camp</b> luring di Surabaya, 5 tim finalis terbaik akan ditantang bertanding dalam permainan interaktif <b>FinRace</b>.
                    </p>
                    <p class="text-xs leading-relaxed text-ink/60 mt-2">
                        Setiap tim dibekali modal awal berupa uang mainan taktis untuk berinvestasi pada portofolio aset, menyelesaikan ragam misi bisnis, dan adu strategi kecepatan serta profitabilitas akumulasi kepemilikan aset riil.
                    </p>
                </div>
                <div class="lg:col-span-5 grid grid-cols-2 gap-3.5 font-heading text-center reveal delay-100">
                    ...
                    <div class="p-4 bg-white/70 rounded-xl border border-manifest-dark/5 shadow-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-md">
                        ...
                        <span class="block text-xs font-bold text-ink mt-0.5">Uang & Nilai Aset</span>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-16 md:py-20 px-4 sm:px-6 md:px-12 relative z-20 bg-[#FAF8F3]/60 border-t border-manifest-dark/5">
            <div class="max-w-[1220px] mx-auto">
                ...
                <div class="max-w-xl mb-10 md:mb-14 text-left reveal">
                    ...
                    <p class="text-xs text-ink/50 mt-2">Perhatikan ritme garis waktu di bawah demi ketepatan pengumpulan berkas administrasi tim delegasi Anda.</p>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
                    ...
                    <div class="timeline-grid-item relative bg-white border border-manifest-dark/5 rounded-[1.4rem] p-5 md:p-6 shadow-sm transition-all duration-500 hover:-translate-y-1 hover:shadow-xl flex flex-col justify-between min-h-[180px] md:min-h-[190px] reveal">
                        <div>
                            ...
                            <p class="text-xs text-manifest-dark/50 mt-2 leading-relaxed">Pembukaan gerbang registrasi administratif serta pengisian database tim peserta.</p>
                        </div>
                    ...
                    <div class="timeline-grid-item relative bg-white border border-manifest-dark/5 rounded-[1.4rem] p-5 md:p-6 shadow-sm transition-all duration-500 hover:-translate-y-1 hover:shadow-xl flex flex-col justify-between min-h-[180px] md:min-h-[190px] reveal delay-100">
                        <div>
                            ...
                            <h3 class="font-heading font-bold text-sm md:text-base text-manifest-dark mt-4">Penyisihan BMC</h3>
                            <p class="text-xs text-manifest-dark/50 mt-2 leading-relaxed">Batas akhir pengumpulan lembar digital rancangan eksklusif Business Model Canvas kelompok.</p>
                        </div>
                        <div class="mt-6 pt-3 border-t border-manifest-dark/5 font-heading text-[10px] font-bold text-manifest-burgundy tracking-wide uppercase">
                            1 - 17 Agustus 2026
                        </div>
                    ...
                    <div class="timeline-grid-item relative bg-white border border-manifest-dark/5 rounded-[1.4rem] p-5 md:p-6 shadow-sm transition-all duration-500 hover:-translate-y-1 hover:shadow-xl flex flex-col justify-between min-h-[180px] md:min-h-[190px] reveal delay-200">
                        <div>
                            ...
                            <p class="text-xs text-manifest-dark/50 mt-2 leading-relaxed">Kurasi ketat dokumen proposal rencana usaha makro bagi kelompok terpilih.</p>
                        </div>
                        <div class="mt-6 pt-3 border-t border-manifest-dark/5 font-heading text-[10px] font-bold text-manifest-burgundy tracking-wide uppercase">
                            31 Ags - 11 Sep 2026
                        </div>
                    ...
                    <div class="timeline-grid-item relative bg-manifest-dark text-white rounded-[1.4rem] p-5 md:p-6 shadow-md transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl flex flex-col justify-between min-h-[180px] md:min-h-[190px] reveal delay-300">
                        <div>
                            ...
                            <p class="text-xs text-white/50 mt-2 leading-relaxed">Karantina 3 hari tatap muka, simulasi FinRace, dan final pitching di hadapan panel ahli juri.</p>
                        </div>
